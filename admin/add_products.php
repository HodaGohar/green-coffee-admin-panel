        ...
        <section class="form-container">
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="input-field">
                    <label>product name <sub>*</sub></label>
                ...
                <div class="input-field">
                    <label>product detail <sub>*</sub></label>
                    <textarea name="content" required maxlength="10000" aria-roledescription="write product description"></textarea>
                </div>
                <div class="input-field">
                    <label>product image <sub>*</sub></label>
